...
Initial project setup was completed, and appropriate documents and folder should be on Github (with the exception of `data/` containing the actual acs2024.csv file on account of it being too big).
