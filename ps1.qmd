...
acs2024_clean <- acs2024_raw %>% 
  ...
  # Indicator categorical vars from EDUC  
...
# Create formatted summary stats table
library(kableExtra)

summary_stats_formatted <- summary_stats_labeled %>%
  kable(
    format = "latex",
    booktabs = TRUE,
    caption = "Table 1. Summary Statistics for 2024 ACS 2024 Sample",
